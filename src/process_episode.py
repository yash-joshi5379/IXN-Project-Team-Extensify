...
EPISODE = "episode_000013"   # Episode number (ensure the number has 6 characters) 
END_FRAME = 265              # The exact frame the task finishes (obtained from find_end_frame.py)
# -------------------------------------------------------------------
